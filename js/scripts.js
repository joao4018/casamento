$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "João e Aline estão Casando",

            // Event start date
            start: new Date('Nov 06, 2021 19:00'),
            ...
            end: new Date('Nov 06, 2021 19:00'),

            // Event Address
            address: 'Capela DiRoma Caldas Novas - GO',

            // Event Description
            description: "Nós te convidamos para esse grande Dia."
        }
    });
